import { PrismaClient, PortfolioCategory, ContactStatus } from '@prisma/client';
...
async function main() {
  ...
  const services = await Promise.all([
    prisma.service.upsert({
      where: { slug: 'commercial-production' },
      update: {},
      create: {
        title: 'Commercial Production',
        slug: 'commercial-production',
        description: 'High-impact commercials that capture attention and drive results. From concept to final cut, we create compelling visual stories for brands.',
        icon: 'Film',
        features: [
          'Concept Development',
          'Scriptwriting',
    ...
    prisma.service.upsert({
      where: { slug: 'corporate-videos' },
      update: {},
      create: {
        title: 'Corporate Videos',
        slug: 'corporate-videos',
        description: 'Professional corporate videos that communicate your brand message effectively. Training videos, company profiles, and internal communications.',
        icon: 'Building2',
        features: [
          'Company Profiles',
          'Training Videos',
    ...
    prisma.service.upsert({
      where: { slug: 'music-videos' },
      update: {},
      create: {
        title: 'Music Videos',
        slug: 'music-videos',
        description: 'Creative music videos that bring your sound to life. We work with artists to create visually stunning videos that resonate with audiences.',
        icon: 'Music',
        features: [
          'Creative Direction',
    ...
    prisma.service.upsert({
      where: { slug: 'documentary-films' },
      update: {},
      create: {
        title: 'Documentary Films',
        slug: 'documentary-films',
        description: 'Compelling documentaries that tell real stories with impact. We capture authentic narratives that inform, inspire, and create change.',
        icon: 'Camera',
        features: [
    ...
    prisma.service.upsert({
      where: { slug: 'social-media-content' },
      update: {},
      create: {
        title: 'Social Media Content',
        slug: 'social-media-content',
        description: 'Engaging social media content optimized for every platform. Reels, stories, and posts that drive engagement and grow your audience.',
        icon: 'Share2',
        features: [
    ...
    prisma.service.upsert({
      where: { slug: 'animation-motion-graphics' },
      update: {},
      create: {
        title: 'Animation & Motion Graphics',
        slug: 'animation-motion-graphics',
        description: '2D and 3D animation that brings concepts to life. Explainer videos, logo animations, and motion graphics that captivate viewers.',
        icon: 'Sparkles',
        features: [
          '2D Animation',
          '3D Animation',
