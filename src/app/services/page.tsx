...
// ISR: render statically and refresh hourly. Never force-dynamic — that made
// every request hit the DB and 500 the page (and the whole SEO ranking) when
// Supabase was briefly unreachable.
...
async function getServices() {
  try {
    ...
    // Degrade gracefully: a DB hiccup renders an empty grid, never a 500.
