    ...
    <nav className="nav">
      <div className="wrap-wide nav-inner">
            ...
            <div className="mega">
              <div className="wrap-wide mega-grid">
                <div className="mega-col">
                  ...
                  <ul>
                    <li>
                      <Link className="mega-link" href="/services/branded-commercials">
                        <span className="ico">B</span>
                        <span>
                          <span className="ml-title">Branded Commercials</span>
                          <span className="ml-sub">TVC · Brand Films · DTC</span>
                        </span>
                    ...
                    <li>
                      <Link className="mega-link" href="/services#corporate">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Anthems · Manifesto · Culture</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    <li>
                      <Link className="mega-link" href="/services#testimonials">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Customer · Founder · Case</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    <li>
                      <Link className="mega-link" href="/services#documentary">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Long-form · Series · Impact</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link className="mega-link" href="/services#shorts">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Reels · TikTok · Shorts</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    <li>
                      <Link className="mega-link" href="/services#product">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Hero shots · Tabletop · CGI</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    <li>
                      <Link className="mega-link" href="/services#educational">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">EdTech · Explainers · Course</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    <li>
                      <Link className="mega-link" href="/services#performance">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Meta · YouTube · Iterative</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link className="mega-link" href="/services#photography">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Editorial · Product · Stills</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link className="mega-link" href="/services#ai">
                        ...
                        <span>
                          ...
                          <span className="ml-sub">Hybrid pipelines · Pitches</span>
                        </span>
                        <span className="ml-arrow">→</span>
                      </Link>
                    </li>
                ...
                <Link className="mega-feature" href="/journal/inside-a-tvc-shoot">
                  ...
                  <div className="mf-body">
                    ...
                    <div className="mf-title">
                      <em>Inside a 6-day TVC shoot</em> — what really makes commercials feel cinematic.
                    </div>
        ...
        <div className="nav-cta">
          <span className="phone-text mono" style={{ fontSize: '11px', letterSpacing: '.18em', color: 'var(--ink-mute)', textTransform: 'uppercase' }}>
            +91 9888 715 815
          </span>
          <button className="theme-toggle" onClick={() => {
            ...
            <svg className="ico-sun" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
              <circle cx="12" cy="12" r="4"/>
              <path d="M12 2v2M12 20v2M2 12h2M20 12h2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/>
            </svg>
            <svg className="ico-moon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
